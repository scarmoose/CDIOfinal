		...
		public void landOnField(Spiller playerWhoLanded) {
			...
			while(playerWhoLanded.getCurrentPos() !=plads[i]){
				...
				case 1:
					...
					playerWhoLanded.updateCurrentPos(updateOneSpaceAhead [i]);//update the position to the new by adding the amount of the number in the array
				...
				case 2:
					...
					playerWhoLanded.updateCurrentPos(updateOneSpaceAhead [i]);
					GUI.setCar(playerWhoLanded.getCurrentPos(), playerWhoLanded.getName());
					break;
				...
				case 6:
					...
					GUI.removeAllCars(playerWhoLanded.getName());
					playerWhoLanded.updateCurrentPos(updateOneSpaceBack [i]);
					GUI.setCar(playerWhoLanded.getCurrentPos(), playerWhoLanded.getName());
					break;
				...
				case 8:
					...
					playerWhoLanded.updateCurrentPos(updateTwoSpaceAhead [i]);
					GUI.setCar(playerWhoLanded.getCurrentPos(), playerWhoLanded.getName());
